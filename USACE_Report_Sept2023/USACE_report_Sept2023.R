...
dat <- read_csv("MAP/data/MAPmaster_yrs1thru19_speciesnames_CLEAN.csv")
#View(dat)
glimpse(dat)
...
# ggsave(filename='MAP/USACE_Report_Sept2023/plots/snook_cpue_yrs1thru19.png', plot = snook_plot,
#        scale = 2.5,
#        width = 10,
#        height = 5,
#        units = c("cm"),
...
# ggsave(filename='MAP/USACE_Report_Sept2023/plots/bass_cpue_yrs1thru19.png', plot = bass_plot,
#        scale = 2.5,
#        width = 10,
#        height = 5,
#        units = c("cm"),
...
# ggsave(filename='MAP/USACE_Report_Sept2023/plots/invasives_cpue_yrs1thru19.png', plot = invasives_plot,
#        scale = 2.5,
#        width = 10,
#        height = 5,
#        units = c("cm"),
...
# ggsave(filename='MAP/USACE_Report_Sept2023/plots/sunfish_cpue_yrs1thru19.png', plot = sf_plot,
#        scale = 2.5,
#        width = 10,
#        height = 5,
#        units = c("cm"),
...
# ggsave(filename='MAP/USACE_Report_Sept2023/plots/LOG_snook_cpue_yrs1thru19.png', plot = LOG_snook_plot,
#        scale = 2.5,
#        width = 10,
#        height = 5,
#        units = c("cm"),
...
# ggsave(filename='MAP/USACE_Report_Sept2023/plots/LOG_bass_cpue_yrs1thru19.png', plot = LOG_bass_plot,
#        scale = 2.5,
#        width = 10,
#        height = 5,
#        units = c("cm"),
...
# ggsave(filename='MAP/USACE_Report_Sept2023/plots/LOG_invasives_cpue_yrs1thru19.png', plot = LOG_invasives_plot,
#        scale = 2.5,
#        width = 10,
#        height = 5,
#        units = c("cm"),
...
# ggsave(filename='MAP/USACE_Report_Sept2023/plots/LOG_sunfish_cpue_yrs1thru19.png', plot = LOG_sf_plot,
#        scale = 2.5,
#        width = 10,
#        height = 5,
#        units = c("cm"),
...
# ggsave(filename='MAP/USACE_Report_Sept2023/plots/sf_biomass_cpue_yrs1thru19.png', plot = sf_biomass_plot,
#        scale = 2.5,
#        width = 10,
#        height = 5,
#        units = c("cm"),
...
# ggsave(filename='MAP/USACE_Report_Sept2023/plots/LOG_sf_biomass_cpue_yrs1thru19.png', plot = LOG_sf_biomass_plot,
#        scale = 2.5,
#        width = 10,
#        height = 5,
#        units = c("cm"),
...
# ggsave(filename='MAP/USACE_Report_Sept2023/plots/LOGplus1_sf_biomass_cpue_yrs1thru19.png', plot = LOGplus1_sf_biomass_plot,
#        scale = 2.5,
#        width = 10,
#        height = 5,
#        units = c("cm"),
